...
class LibraryController extends Controller
{
    ...
    public function index(Request $request){        
        ...
        $data['audio'] = LibraryAudio::get()->toArray();
        $data['books'] = LibraryBook::get();
    ...
    public function details($id){        
        $data = LibraryAudio::join('users','users.id','=','tbl_library_audio.uid')->select('tbl_library_audio.*','users.name')->where('tbl_library_audio.id',$id)->get()->toArray();
        // if($data){
