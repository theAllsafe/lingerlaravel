...
use App\Models\IslamicFestivals;
use Validator;
class AdminIslamicFestivalsController extends Controller
{
    public $successStatus = 200;
    public $valerrorStatus = 500;
    public $errorStatus = 401;
    public function index(){     
        $data = IslamicFestivals::get();
    ...
    {
        $users=IslamicFestivals::findOrFail($id);
        $users->delete();
