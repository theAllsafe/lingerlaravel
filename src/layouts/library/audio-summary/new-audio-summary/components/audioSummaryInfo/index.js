...
function SlotInfo() {
  ...
  const save = async () => {
    ...
    let result = await fetch(`${process.env.REACT_APP_DHEERAJ_KEY}admin/library/audio/store`, {
      method: "POST",
      body: formDate,
    });
  ...
  return (
    <Card className="overflow-visible">
      ...
      <SuiBox p={3}>
        <SuiTypography variant="h5">Audio Summary</SuiTypography>
        <SuiBox mt={1}>
          <Grid container spacing={3}>
            <Grid item xs={12} sm={12}>
              ...
              <SuiEditor value={setTitle} onChange={setTitle} />
            </Grid>
          </Grid>
        </SuiBox>
      </SuiBox>
