...
function ProductsList() {
  const [columns] = useState([
    ...
    { name: "father_name", align: "center" },
    { name: "mother_name", align: "center" },
    { name: "baby_name", align: "center" },
  ...
  const fetchProducts = async () => {
    // setIsLoading(true);
    let result = await fetch(`${process.env.REACT_APP_DHEERAJ_KEY}admin/babyNames/`);
