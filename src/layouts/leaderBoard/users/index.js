...
function ProductsList() {
  const [columns] = useState([
    ...
    { name: "Following", align: "center" },
    { name: "Achivement", align: "center" },
    { name: "Payment", align: "center" },
    { name: "Order ID", align: "center" },
    { name: "Linger Status", align: "center" },
  ...
  const [rowname] = useState([
    ...
    { name: "total_like", align: "center" },
    { name: "total_followers", align: "center" },
    { name: "total_following", align: "center" },
    { name: "total_following", align: "center" },
    { name: "total_following", align: "center" },
    { name: "total_following", align: "center" },
    { name: "prime_status", align: "center" },
    { name: "Action", align: "left" },
  ]);
  const { light } = colors;
  ...
  const fetchProducts = async () => {
    // setIsLoading(true);
    let result = await fetch(`${process.env.REACT_APP_DHEERAJ_KEY}admin/allusers/`);
  ...
  const deleteRow = async (id) => {
    ...
    const result = await axios
      .delete(`${process.env.REACT_APP_DHEERAJ_KEY}admin/sukoon/destroy/${id}`)
      .then(({ data }) => {
        Swal.fire({
          icon: "success",
          text: data.message,
